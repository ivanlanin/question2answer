...
*/
    ...
    return array(
        ...
        'remoderate_body' => "Kiriman yang telah dirubah by ^p_handle memerlukan persetujuan:\n\n^open^p_context^close\n\nTekan tombol di bawah untuk menyetujui atau menyembunyikan:\n\n^url\n\n\nTekan tombol berikut untuk mereview semua kiriman:\n\n^a_url\n\n\nThank you,\n\n^site_title",
        'remoderate_subject' => '^site_title moderasi',
        ...
        'u_registered_body' => "Pengguna baru telah terdaftar sebagai ^u_handle.\n\nKlik disini untuk menampilkan profil pengguna:\n\n^url\n\nThank you,\n\n^site_title",
        'u_to_approve_body' => "Pengguna baru telah terdaftar sebagai ^u_handle.\n\nKlik disini untuk verifikasi pengguna:\n\n^url\n\nClick below to review all users waiting for approval:\n\n^a_url\n\nThank you,\n\n^site_title",
        'u_registered_subject' => '^site_title ada pengguna baru',

        'u_approved_body' => "Anda bisa melihat profil bari anda di sini:\n\n^url\n\nThank you,\n\n^site_title",
        'u_approved_subject' => '^site_title telah disetujui',

        'wall_post_subject' => 'Kiriman pada dinding ^site_title',
        'wall_post_body' => "^f_handle telah mengirim pada ^site_title mu:\n\n^open^post^close\n\nAnda bisa meresponnya disini:\n\n^url\n\nThank you,\n\n^site_title",
